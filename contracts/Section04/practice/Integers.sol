...
contract Integers {
    ...
    /// @dev 比較演算子
    // 以下
    bool public c1 = (i <= 256); // comparison

    // 未満
    bool public c2 = (i < 256);

    // イコール
    bool public c3 = (i == 256);

    // イコールではない
    bool public c4 = (i != 256);

    // 以上
    bool public c5 = (i >= 256);

    // より大きい
    bool public c6 = (i > 256);

    /// @dev 型違いは比較できないので注意。比較したいときは型を合わせる
    //bool public c7 = (i == u); // Comple Error
    bool public c8 = (uint(i) == u);
    ...
    //int256 public c = 3.1 + 1.8 + 4; // 結果が小数になるためコンパイルエラー
